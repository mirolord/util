        ...
        try {
            ...
            for (int i = 0; i < args.length; i++) {
                ...
                if (arg.matches("-.")) {
                    ...
                    if (key == 'o') {
                        if ((i + 1) >= args.length) {
                            throw new Exception("Не указан путь после ключа \"o\".");
                        }
                        ...
                        try {
                            ...
                            throw new Exception("Не верно указан путь после ключа \"o\": \"" + e.getMessage() + "\"");
                        }
                    } else if (key == 'p') {
                        if ((i + 1) >= args.length) {
                            throw new Exception("Не указан префикс после ключа \"p\".");
                        }
                        if (!validateStringFilename(args[i + 1])) {
                            throw new Exception("Недопустимое наименование префикса после ключа \"p\".");
                        }
                        ...
                        throw new Exception("Недопустимый ключ: \"" + key + "\"");
                    }
                } else {
